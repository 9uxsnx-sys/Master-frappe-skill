---
description: Generate a professional, itemized ERP proposal and accurate price estimate for a KSA-market client based on their requirements.
---

# ERPNext KSA — Elite Proposal Generator
...
- [ ] **ZATCA** — Is the client VAT-registered in KSA? Revenue above SAR 3M? Phase 1 or Phase 2 required?
...
### C — KSA COMPLIANCE & REGULATORY

#### C1. ZATCA e-Invoicing (Mandatory for all VAT-registered businesses)
...
| Phase 1 + Phase 2 + GOSI/MUDAD        | Full invoice compliance + payroll protection compliance | $16,500 |

> Always recommend **Full (Phase 1 + 2)** unless client has explicit documented reason.
> Non-compliance risk: up to **$13,000 per invoice violation** + bank account freeze + trade license revocation.

#### C2. GOSI Integration (standalone if not bundled above)
**$5,000**

#### C3. MUDAD / WPS — Wage Protection System (standalone)
**$3,500**
...
🇸🇦 ENGINEERED FOR THE KSA MARKET
   ZATCA compliance is not an add-on. It is the foundation.
   Arabic RTL, bilingual documents, GOSI, MUDAD, Vision 2030
   readiness — all built into every system we deliver.
...
📋 DOCUMENTATION THAT ACTUALLY EXISTS
   ...
   and training materials — all included, all in Arabic/English.

🛡️ COMPLIANCE PROTECTION — Your Insurance Policy
   ZATCA violations: up to SAR 187,000 per offense.
   Bank account freezes. Trade license revocations.
   Our implementations ensure you are fully protected
   from day one, not retrofitted for compliance later.
